    ...
    games.forEach(function (turns, i) {
      ...
      turns.forEach(function (world, j) {
        ...
        world.societies.forEach(function (society, k) {
          ...
          console.log(kndent, 'dispositions.of', JSON.stringify(society.dispositions.of));
          console.log(kndent, 'dispositions.from', JSON.stringify(society.dispositions.from));
        });
      });
    });
  });
